...
class LongToIntMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(LongToIntMap.class),
    ...
    void testInsert()
    {
        final LongToIntMap m = new LongToIntMap(new LongSet(new OrderedLongList(new FixedLongList(1))),new FixedIntList(1));
        m.insert(1,2);
    ...
    void testKeys()
    {
        ...
        assertSame(k,new LongToIntMap(k,new FixedIntList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new LongToIntMap(new LongSet(new OrderedLongList(new FixedLongList(1))),v).values());
    }
}