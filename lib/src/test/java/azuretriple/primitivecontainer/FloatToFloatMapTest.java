...
class FloatToFloatMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(FloatToFloatMap.class),
    ...
    void testInsert()
    {
        final FloatToFloatMap m = new FloatToFloatMap(new FloatSet(new OrderedFloatList(new FixedFloatList(1))),new FixedFloatList(1));
        m.insert((float)1,(float)2);
        assertTrue(m.keys().contains((float)1));
        assertEquals((float)2,m.get((float)1));
    }
    ...
    {
        final FloatToFloatMap m = new FloatToFloatMap(new FloatSet(new OrderedFloatList(new FixedFloatList(1))),new FixedFloatList(1));
        m.put((float)1,(float)2);
        assertTrue(m.keys().contains((float)1));
        assertEquals((float)2,m.get((float)1));
        m.put((float)1,(float)3);
        assertTrue(m.keys().contains((float)1));
        assertEquals((float)3,m.get((float)1));
        m.put((float)1,(float)3);
        assertTrue(m.keys().contains((float)1));
        assertEquals((float)3,m.get((float)1));
    }
    ...
    {
        final FloatToFloatMap m = new FloatToFloatMap(new FloatSet(new OrderedFloatList(new FixedFloatList(1))),new FixedFloatList(1));
        assertTrue(m.add((float)1,(float)2));
        assertTrue(m.keys().contains((float)1));
        assertEquals((float)2,m.get((float)1));
        assertTrue(m.add((float)1,(float)3));
        assertEquals((float)3,m.get((float)1));
        assertFalse(m.add((float)1,(float)3));
    }
    ...
    void testExtract()
    {
        final FloatToFloatMap m = new FloatToFloatMap(new FloatSet(new OrderedFloatList(new FixedFloatList(1))),new FixedFloatList(1));
        m.insert((float)1,(float)2);
        assertEquals((float)2,m.extract((float)1));
    }
    ...
    void testKeys()
    {
        ...
        assertSame(k,new FloatToFloatMap(k,new FixedFloatList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new FloatToFloatMap(new FloatSet(new OrderedFloatList(new FixedFloatList(1))),v).values());
    }
}