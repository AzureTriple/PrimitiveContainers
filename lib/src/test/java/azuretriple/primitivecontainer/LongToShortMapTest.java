...
class LongToShortMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(LongToShortMap.class),
    ...
    void testInsert()
    {
        final LongToShortMap m = new LongToShortMap(new LongSet(new OrderedLongList(new FixedLongList(1))),new FixedShortList(1));
        m.insert(1,(short)2);
    ...
    void testKeys()
    {
        ...
        assertSame(k,new LongToShortMap(k,new FixedShortList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new LongToShortMap(new LongSet(new OrderedLongList(new FixedLongList(1))),v).values());
    }
}