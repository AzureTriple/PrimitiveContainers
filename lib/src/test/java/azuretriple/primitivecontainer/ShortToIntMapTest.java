...
class ShortToIntMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(ShortToIntMap.class),
    ...
    void testInsert()
    {
        final ShortToIntMap m = new ShortToIntMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),new FixedIntList(1));
        m.insert((short)1,2);
    ...
    void testKeys()
    {
        ...
        assertSame(k,new ShortToIntMap(k,new FixedIntList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new ShortToIntMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),v).values());
    }
}