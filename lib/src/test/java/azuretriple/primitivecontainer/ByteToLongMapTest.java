...
class ByteToLongMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(ByteToLongMap.class),
    ...
    void testInsert()
    {
        final ByteToLongMap m = new ByteToLongMap(new ByteSet(new OrderedByteList(new FixedByteList(1))),new FixedLongList(1));
        m.insert((byte)1,2);
    ...
    void testKeys()
    {
        ...
        assertSame(k,new ByteToLongMap(k,new FixedLongList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new ByteToLongMap(new ByteSet(new OrderedByteList(new FixedByteList(1))),v).values());
    }
}