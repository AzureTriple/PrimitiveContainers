...
class DoubleToShortMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(DoubleToShortMap.class),
    ...
    void testInsert()
    {
        final DoubleToShortMap m = new DoubleToShortMap(new DoubleSet(new OrderedDoubleList(new FixedDoubleList(1))),new FixedShortList(1));
        m.insert(1,(short)2);
    ...
    void testKeys()
    {
        ...
        assertSame(k,new DoubleToShortMap(k,new FixedShortList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new DoubleToShortMap(new DoubleSet(new OrderedDoubleList(new FixedDoubleList(1))),v).values());
    }
}