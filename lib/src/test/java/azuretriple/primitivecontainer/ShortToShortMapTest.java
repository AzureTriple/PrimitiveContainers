...
class ShortToShortMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(ShortToShortMap.class),
    ...
    void testInsert()
    {
        final ShortToShortMap m = new ShortToShortMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),new FixedShortList(1));
        m.insert((short)1,(short)2);
        assertTrue(m.keys().contains((short)1));
        assertEquals((short)2,m.get((short)1));
    }
    ...
    {
        final ShortToShortMap m = new ShortToShortMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),new FixedShortList(1));
        m.put((short)1,(short)2);
        assertTrue(m.keys().contains((short)1));
        assertEquals((short)2,m.get((short)1));
        m.put((short)1,(short)3);
        assertTrue(m.keys().contains((short)1));
        assertEquals((short)3,m.get((short)1));
        m.put((short)1,(short)3);
        assertTrue(m.keys().contains((short)1));
        assertEquals((short)3,m.get((short)1));
    }
    ...
    {
        final ShortToShortMap m = new ShortToShortMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),new FixedShortList(1));
        assertTrue(m.add((short)1,(short)2));
        assertTrue(m.keys().contains((short)1));
        assertEquals((short)2,m.get((short)1));
        assertTrue(m.add((short)1,(short)3));
        assertEquals((short)3,m.get((short)1));
        assertFalse(m.add((short)1,(short)3));
    }
    ...
    void testExtract()
    {
        final ShortToShortMap m = new ShortToShortMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),new FixedShortList(1));
        m.insert((short)1,(short)2);
        assertEquals((short)2,m.extract((short)1));
    }
    ...
    void testKeys()
    {
        ...
        assertSame(k,new ShortToShortMap(k,new FixedShortList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new ShortToShortMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),v).values());
    }
}