...
class ByteToByteMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(ByteToByteMap.class),
    ...
    void testInsert()
    {
        final ByteToByteMap m = new ByteToByteMap(new ByteSet(new OrderedByteList(new FixedByteList(1))),new FixedByteList(1));
        m.insert((byte)1,(byte)2);
        assertTrue(m.keys().contains((byte)1));
        assertEquals((byte)2,m.get((byte)1));
    }
    ...
    void testPut()
    {
        ...
        m.put((byte)1,(byte)3);
        assertTrue(m.keys().contains((byte)1));
        assertEquals((byte)3,m.get((byte)1));
        m.put((byte)1,(byte)3);
        assertTrue(m.keys().contains((byte)1));
        assertEquals((byte)3,m.get((byte)1));
    }
    ...
    {
        final ByteToByteMap m = new ByteToByteMap(new ByteSet(new OrderedByteList(new FixedByteList(1))),new FixedByteList(1));
        assertTrue(m.add((byte)1,(byte)2));
        assertTrue(m.keys().contains((byte)1));
        assertEquals((byte)2,m.get((byte)1));
        assertTrue(m.add((byte)1,(byte)3));
        assertEquals((byte)3,m.get((byte)1));
        assertFalse(m.add((byte)1,(byte)3));
    }
    ...
    void testExtract()
    {
        final ByteToByteMap m = new ByteToByteMap(new ByteSet(new OrderedByteList(new FixedByteList(1))),new FixedByteList(1));
        m.insert((byte)1,(byte)2);
        assertEquals((byte)2,m.extract((byte)1));
    }
    ...
    void testKeys()
    {
        ...
        assertSame(k,new ByteToByteMap(k,new FixedByteList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new ByteToByteMap(new ByteSet(new OrderedByteList(new FixedByteList(1))),v).values());
    }
}