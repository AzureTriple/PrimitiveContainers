...
class ShortToFloatMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(ShortToFloatMap.class),
    ...
    void testInsert()
    {
        final ShortToFloatMap m = new ShortToFloatMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),new FixedFloatList(1));
        m.insert((short)1,(float)2);
        assertTrue(m.keys().contains((short)1));
        assertEquals((float)2,m.get((short)1));
    }
    ...
    {
        final ShortToFloatMap m = new ShortToFloatMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),new FixedFloatList(1));
        m.put((short)1,(float)2);
        assertTrue(m.keys().contains((short)1));
        assertEquals((float)2,m.get((short)1));
        m.put((short)1,(float)3);
        assertTrue(m.keys().contains((short)1));
        assertEquals((float)3,m.get((short)1));
        m.put((short)1,(float)3);
        assertTrue(m.keys().contains((short)1));
        assertEquals((float)3,m.get((short)1));
    }
    ...
    {
        final ShortToFloatMap m = new ShortToFloatMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),new FixedFloatList(1));
        assertTrue(m.add((short)1,(float)2));
        assertTrue(m.keys().contains((short)1));
        assertEquals((float)2,m.get((short)1));
        assertTrue(m.add((short)1,(float)3));
        assertEquals((float)3,m.get((short)1));
        assertFalse(m.add((short)1,(float)3));
    }
    ...
    void testExtract()
    {
        final ShortToFloatMap m = new ShortToFloatMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),new FixedFloatList(1));
        m.insert((short)1,(float)2);
        assertEquals((float)2,m.extract((short)1));
    }
    ...
    void testKeys()
    {
        ...
        assertSame(k,new ShortToFloatMap(k,new FixedFloatList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new ShortToFloatMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),v).values());
    }
}