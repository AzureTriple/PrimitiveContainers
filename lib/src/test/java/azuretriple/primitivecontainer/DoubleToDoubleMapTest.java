...
class DoubleToDoubleMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(DoubleToDoubleMap.class),
    ...
    void testInsert()
    {
        final DoubleToDoubleMap m = new DoubleToDoubleMap(new DoubleSet(new OrderedDoubleList(new FixedDoubleList(1))),new FixedDoubleList(1));
        m.insert(1,2);
    ...
    void testKeys()
    {
        ...
        assertSame(k,new DoubleToDoubleMap(k,new FixedDoubleList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new DoubleToDoubleMap(new DoubleSet(new OrderedDoubleList(new FixedDoubleList(1))),v).values());
    }
}