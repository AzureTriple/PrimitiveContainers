...
class ByteToDoubleMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(ByteToDoubleMap.class),
    ...
    void testInsert()
    {
        final ByteToDoubleMap m = new ByteToDoubleMap(new ByteSet(new OrderedByteList(new FixedByteList(1))),new FixedDoubleList(1));
        m.insert((byte)1,2);
    ...
    void testKeys()
    {
        ...
        assertSame(k,new ByteToDoubleMap(k,new FixedDoubleList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new ByteToDoubleMap(new ByteSet(new OrderedByteList(new FixedByteList(1))),v).values());
    }
}