...
public record FloatSet(OrderedFloatList data) implements Cloneable
{
    ...
    public void union(final FloatSet other)
    {
        final FloatList a = data.list;
        final float[] b = other.data.list.data();
    ...
    public void intersect(final FloatSet other)
    {
        final float[] a = data.list.data(),b = other.data.list.data();
    ...
    public void subtract(final FloatSet other)
    {
        final float[] a = data.list.data(),b = other.data.list.data();
        final int al = data.list.size(),bl = other.data.list.size();
        int ai = 0,bi = 0,ci = 0;
