...
class IntToFloatMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(IntToFloatMap.class),
    ...
    void testInsert()
    {
        final IntToFloatMap m = new IntToFloatMap(new IntSet(new OrderedIntList(new FixedIntList(1))),new FixedFloatList(1));
        m.insert(1,(float)2);
    ...
    void testKeys()
    {
        ...
        assertSame(k,new IntToFloatMap(k,new FixedFloatList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new IntToFloatMap(new IntSet(new OrderedIntList(new FixedIntList(1))),v).values());
    }
}