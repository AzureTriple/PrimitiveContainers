...
class ShortToLongMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(ShortToLongMap.class),
    ...
    void testInsert()
    {
        final ShortToLongMap m = new ShortToLongMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),new FixedLongList(1));
        m.insert((short)1,2);
    ...
    void testKeys()
    {
        ...
        assertSame(k,new ShortToLongMap(k,new FixedLongList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new ShortToLongMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),v).values());
    }
}