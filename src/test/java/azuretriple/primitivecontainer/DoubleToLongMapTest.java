...
class DoubleToLongMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(DoubleToLongMap.class),
    ...
    void testInsert()
    {
        final DoubleToLongMap m = new DoubleToLongMap(new DoubleSet(new OrderedDoubleList(new FixedDoubleList(1))),new FixedLongList(1));
        m.insert(1,2);
    ...
    void testKeys()
    {
        ...
        assertSame(k,new DoubleToLongMap(k,new FixedLongList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new DoubleToLongMap(new DoubleSet(new OrderedDoubleList(new FixedDoubleList(1))),v).values());
    }
}