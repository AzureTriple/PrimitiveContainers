...
class FloatToIntMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(FloatToIntMap.class),
    ...
    void testInsert()
    {
        final FloatToIntMap m = new FloatToIntMap(new FloatSet(new OrderedFloatList(new FixedFloatList(1))),new FixedIntList(1));
        m.insert((float)1,2);
    ...
    void testKeys()
    {
        ...
        assertSame(k,new FloatToIntMap(k,new FixedIntList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new FloatToIntMap(new FloatSet(new OrderedFloatList(new FixedFloatList(1))),v).values());
    }
}