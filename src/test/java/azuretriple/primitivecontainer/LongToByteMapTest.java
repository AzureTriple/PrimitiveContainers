...
class LongToByteMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(LongToByteMap.class),
    ...
    void testInsert()
    {
        final LongToByteMap m = new LongToByteMap(new LongSet(new OrderedLongList(new FixedLongList(1))),new FixedByteList(1));
        m.insert(1,(byte)2);
    ...
    void testKeys()
    {
        ...
        assertSame(k,new LongToByteMap(k,new FixedByteList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new LongToByteMap(new LongSet(new OrderedLongList(new FixedLongList(1))),v).values());
    }
}