...
class IntToDoubleMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(IntToDoubleMap.class),
    ...
    void testInsert()
    {
        final IntToDoubleMap m = new IntToDoubleMap(new IntSet(new OrderedIntList(new FixedIntList(1))),new FixedDoubleList(1));
        m.insert(1,2);
    ...
    void testKeys()
    {
        ...
        assertSame(k,new IntToDoubleMap(k,new FixedDoubleList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new IntToDoubleMap(new IntSet(new OrderedIntList(new FixedIntList(1))),v).values());
    }
}