...
class ShortToByteMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(ShortToByteMap.class),
    ...
    void testInsert()
    {
        final ShortToByteMap m = new ShortToByteMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),new FixedByteList(1));
        m.insert((short)1,(byte)2);
        assertTrue(m.keys().contains((short)1));
        assertEquals((byte)2,m.get((short)1));
    }
    ...
    {
        final ShortToByteMap m = new ShortToByteMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),new FixedByteList(1));
        m.put((short)1,(byte)2);
        assertTrue(m.keys().contains((short)1));
        assertEquals((byte)2,m.get((short)1));
        m.put((short)1,(byte)3);
        assertTrue(m.keys().contains((short)1));
        assertEquals((byte)3,m.get((short)1));
        m.put((short)1,(byte)3);
        assertTrue(m.keys().contains((short)1));
        assertEquals((byte)3,m.get((short)1));
    }
    ...
    {
        final ShortToByteMap m = new ShortToByteMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),new FixedByteList(1));
        assertTrue(m.add((short)1,(byte)2));
        assertTrue(m.keys().contains((short)1));
        assertEquals((byte)2,m.get((short)1));
        assertTrue(m.add((short)1,(byte)3));
        assertEquals((byte)3,m.get((short)1));
        assertFalse(m.add((short)1,(byte)3));
    }
    ...
    void testExtract()
    {
        final ShortToByteMap m = new ShortToByteMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),new FixedByteList(1));
        m.insert((short)1,(byte)2);
        assertEquals((byte)2,m.extract((short)1));
    }
    ...
    void testKeys()
    {
        ...
        assertSame(k,new ShortToByteMap(k,new FixedByteList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new ShortToByteMap(new ShortSet(new OrderedShortList(new FixedShortList(1))),v).values());
    }
}