...
class FloatToDoubleMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(FloatToDoubleMap.class),
    ...
    void testInsert()
    {
        final FloatToDoubleMap m = new FloatToDoubleMap(new FloatSet(new OrderedFloatList(new FixedFloatList(1))),new FixedDoubleList(1));
        m.insert((float)1,2);
    ...
    void testKeys()
    {
        ...
        assertSame(k,new FloatToDoubleMap(k,new FixedDoubleList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new FloatToDoubleMap(new FloatSet(new OrderedFloatList(new FixedFloatList(1))),v).values());
    }
}