...
class IntToLongMapTest
{
    @Test
    void testInit()
    {
        final Class<?>[] pair = AssertionUtil.getAssertionPair(IntToLongMap.class),
    ...
    void testInsert()
    {
        final IntToLongMap m = new IntToLongMap(new IntSet(new OrderedIntList(new FixedIntList(1))),new FixedLongList(1));
        m.insert(1,2);
    ...
    void testKeys()
    {
        ...
        assertSame(k,new IntToLongMap(k,new FixedLongList(1)).keys());
    }
    ...
    void testValues()
    {
        ...
        assertSame(v,new IntToLongMap(new IntSet(new OrderedIntList(new FixedIntList(1))),v).values());
    }
}